...
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "formmain_0001")
public class Formmain0001 implements Serializable {
    ...
    @TableField(value = "field0037")
    private String field0037;

    @TableField(value = "field0038")
    private String field0038;

    @TableField(value = "field0039")
    private String field0039;

    @TableField(value = "field0040")
    private BigDecimal field0040;

    @TableField(value = "field0041")
    private BigDecimal field0041;

    @TableField(value = "field0042")
    private Short field0042;

    @TableField(value = "field0043")
    private BigDecimal field0043;

    @TableField(value = "field0044")
    private BigDecimal field0044;

    @TableField(value = "field0045")
    private Short field0045;

    @TableField(value = "field0046")
    private Short field0046;

    @TableField(value = "field0047")
    private Short field0047;

    @TableField(value = "field0048")
    private BigDecimal field0048;

    @TableField(value = "field0049")
    private BigDecimal field0049;

    @TableField(value = "field0050")
    private Short field0050;

    @TableField(value = "field0051")
    private String field0051;

    @TableField(value = "field0052")
    private String field0052;

    @TableField(value = "field0053")
    private String field0053;

    @TableField(value = "field0054")
    private String field0054;

    @TableField(value = "field0055")
    private String field0055;

    @TableField(value = "field0056")
    private String field0056;

    @TableField(value = "field0057")
    private Date field0057;

    @TableField(value = "field0058")
    private String field0058;

    @TableField(value = "field0059")
    private Date field0059;

    @TableField(value = "field0060")
    private Date field0060;

    @TableField(value = "field0061")
    ...
    public static final String COL_FIELD0052 = "field0052";

    public static final String COL_FIELD0053 = "field0053";

    public static final String COL_FIELD0054 = "field0054";

    public static final String COL_FIELD0055 = "field0055";

    public static final String COL_FIELD0056 = "field0056";

    public static final String COL_FIELD0057 = "field0057";

    public static final String COL_FIELD0058 = "field0058";

    public static final String COL_FIELD0059 = "field0059";

    public static final String COL_FIELD0060 = "field0060";

    public static final String COL_FIELD0061 = "field0061";
}