...
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "formmain_0086")
public class Formmain0086 implements Serializable {
    ...
    private BigDecimal field0002;

    @TableField(value = "field0003")
    private BigDecimal field0003;

    @TableField(value = "field0004")
    private BigDecimal field0004;
