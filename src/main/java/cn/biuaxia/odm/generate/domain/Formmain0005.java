...
@AllArgsConstructor
@NoArgsConstructor
@TableName(value = "formmain_0005")
public class Formmain0005 implements Serializable {
    @TableField(value = "ID")
    ...
    private Short field0012;

    @TableField(value = "field0013")
    private Short field0013;

    @TableField(value = "field0014")
    private Short field0014;

    @TableField(value = "field0015")
    private Short field0015;

    @TableField(value = "field0016")
    private Short field0016;

    @TableField(value = "field0017")
    private Short field0017;

    @TableField(value = "field0018")
    private Short field0018;

    @TableField(value = "field0019")
    private BigDecimal field0019;

    @TableField(value = "field0020")
    private Short field0020;
