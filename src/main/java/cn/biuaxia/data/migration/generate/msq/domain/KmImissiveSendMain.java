...
public class KmImissiveSendMain implements Serializable {
    ...
    public static KmImissiveSendMain build(MvFormsetInst mvFormsetInst) {
        return KmImissiveSendMain.builder()
                .fdId(IdUtil.fastSimpleUUID())
                .docSubject(mvFormsetInst.getName())
                .docCreateTime(mvFormsetInst.getCreateTime())
                .fdFlowNo(mvFormsetInst.getExt8())
                .fdDocNum(mvFormsetInst.getExt16())
                .fdDraftTime(mvFormsetInst.getExt27())
                .build();
    }
